...
* **Raw PNGs** - Original 1024x1024 renders without padding or shadow. Not ideal for direct replacement (appears oversized).
...
* **Padded Shadow PNGs** - Sized and shadowed to visually match modern macOS icons. Recommended for most users replacing the app icon ✅
...
### 🧩 Developers, for use in Icon Composer
...
Created by **Johann Goza**. Pull requests and improvements are welcome! :)
